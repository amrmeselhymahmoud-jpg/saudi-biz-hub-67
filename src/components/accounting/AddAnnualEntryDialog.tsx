...
interface AddAnnualEntryDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess: () => void;
}

export function AddAnnualEntryDialog({ open, onOpenChange, onSuccess }: AddAnnualEntryDialogProps) {
  const { user } = useAuth();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "تم إضافة القيد السنوي بنجاح"
      });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>إضافة قيد سنوي</DialogTitle>
          <DialogDescription>
            أدخل بيانات القيد السنوي
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="grid gap-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="افتتاحي">قيد افتتاحي</SelectItem>
                  <SelectItem value="ختامي">قيد ختامي</SelectItem>
                  <SelectItem value="تسوية">قيد تسوية</SelectItem>
                  <SelectItem value="نتائج أعمال">قيد نتائج الأعمال</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e) => setEntry({...entry, fiscal_year: Number(e.target.value)})}
              />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              placeholder="أدخل وصف القيد السنوي"
              rows={2}
            />
          </div>
